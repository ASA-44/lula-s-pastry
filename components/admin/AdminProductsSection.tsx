import { AlertTriangle, Ban, Download, MoreVertical, Package, Pencil, PlusCircle, Trash2 } from "lucide-react";
...
export function getAdminProductCategories(dishes: Dish[]) {
  return Array.from(new Set(dishes.map((dish) => categoryLabel(dish.category)))).slice(0, 5);
}

export function AdminProductsSection({ categories, dishes }: AdminProductsSectionProps) {
  return (
    <div className="admin-content admin-products-content">
      <div className="admin-products-title">
        <div>
          ...
          <p>
            Manage your artisanal collection of handcrafted pastries and signature cakes. Keep the daily menu
            polished, available, and ready for customer orders.
          </p>
        </div>
                  ...
                  <div className="admin-product-footer">
                    ...
                    <div className="admin-product-actions">
                      ...
                      <form action={deleteDishAction}>
                        ...
                        <Button type="submit" variant="productIcon" className="danger" aria-label={`Delete ${dish.name}`}>
                          <Trash2 size={18} />
                        </Button>
                      </form>
                    </div>
